...
export function SearchSection() {
  ...
  return (
    <section id="search" className="max-w-6xl mx-auto px-5 sm:px-8 md:px-12 py-20 md:py-28 border-t border-[#1a1a1a]">
      <RevealOnScroll>
      ...
      <RevealOnScroll delay={100} className="mt-14">
        <div className="relative border border-[#1a1a1a] rounded-2xl bg-[#0b0b0b] p-6 sm:p-10 md:p-16 overflow-hidden">
          ...
          <p className="text-base sm:text-lg text-[#a1a1aa] max-w-md leading-relaxed mb-8 sm:mb-10 relative z-10">
            Ask Memo anything about anything you&apos;ve ever recorded. It searches across every session, every word, every moment.
          </p>
          <div className="relative z-10 border border-[#2a2a2a] rounded-xl px-4 sm:px-5 py-3 sm:py-4 flex items-center gap-3.5 mb-6 sm:mb-8 hover:border-[rgba(201,106,203,0.3)] transition-colors duration-200" style={{ background: "rgba(255,255,255,0.04)" }}>
          ...
          <div className="relative z-10 flex flex-wrap gap-2.5">
            {SEARCH_EXAMPLES.map((ex) => (
              <button key={ex} onClick={() => typeDemo(ex)}
                className="text-xs sm:text-sm text-[#a1a1aa] border border-[#1a1a1a] rounded-lg px-3 sm:px-3.5 py-1 sm:py-1.5 hover:border-[#c96acb] hover:text-[#c96acb] transition-all duration-200 text-left"
